...
class Model:
    ...
    def _build_net(self):        
        with tf.variable_scope(self._name):
            ...
            pool1 = tf.layers.max_pooling2d(inputs=conv12, pool_size=[2,2], padding="SAME", strides=2)               # (?,8,8,64)16            
            ...
            pool2 = tf.layers.max_pooling2d(inputs=conv23, pool_size=[2,2], padding="SAME", strides=2)               # (4,4)          
